...
public class Calibrate3dPipeTest extends Application{
    ...
    public static void main(String[] args){
        ...
        findBoardCornersPipe.setParams(new FindBoardCornersPipe.FindCornersPipeParams(11, 4, false, 5));
        ...
        CVPipeResult<CameraCalibrationCoefficients> calibrate3dPipeOutput= calibrate3dPipe.apply(findBoardCornersPipeOutput.result);
        for(double d : calibrate3dPipeOutput.result.getPerViewErrors()) data.add(d);
        findBoardCornersPipeOutput.result.get(0).forEach(mat -> {
