...
public class PicamJNI {
    ...
    //         false; // TODO once we've sorted out what apriltags needs to be doing, we can bring
    // this back?
    ...
    //         // We always extract the shared object (we could hash each so, but that's a lot of
    // work)
