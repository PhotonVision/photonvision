...
@JsonTypeName("AprilTagCudaPipelineSettings")
public class AprilTagCudaPipelineSettings extends AdvancedPipelineSettings {
  ...
  public AprilTagCudaPipelineSettings() {
    super();
