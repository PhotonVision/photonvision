...
public class LibcameraGpuSettables extends VisionSourceSettables {
    ...
    public LibcameraGpuSettables(CameraConfiguration configuration) {
        ...
        if (sensorModel == LibCameraJNI.SensorModel.IMX219) {
            ...
            videoModes.put(0, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 320, 240, 120, 120, .39));
            videoModes.put(1, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 320, 240, 30, 30, .39));
            videoModes.put(2, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 640, 480, 65, 90, .39));
            videoModes.put(3, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 640, 480, 30, 30, .39));
            // TODO: fix 1280x720 in the native code and re-add it
            videoModes.put(4, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 1920, 1080, 15, 20, .53));
            videoModes.put(5, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 3280 / 2, 2464 / 2, 15, 20, 1));
            videoModes.put(6, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 3280 / 4, 2464 / 4, 15, 20, 1));
            ...
            videoModes.put(0, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 640, 400, 120, 240, 1));
            videoModes.put(1, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 1280, 800, 120, 120, 1));
            ...
            videoModes.put(0, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 320, 240, 90, 90, 1));
            videoModes.put(1, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 640, 480, 85, 90, 1));
            videoModes.put(2, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 960, 720, 45, 49, 0.74));
            // Half the size of the active areas on the OV5647
            videoModes.put(3, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 2592 / 2, 1944 / 2, 20, 20, 1));
            videoModes.put(4, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 1280, 720, 30, 45, 0.91));
            videoModes.put(5, new FPSRatedVideoMode(PixelFormat.UNKNOWN, 1920, 1080, 15, 20, 0.72));
        }
