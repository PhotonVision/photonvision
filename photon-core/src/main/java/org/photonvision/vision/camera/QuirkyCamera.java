...
public class QuirkyCamera {
    private static final List<QuirkyCamera> quirkyCameras =
            List.of(
                    ...
                    new QuirkyCamera(0x0bda, 0x5510, CameraQuirk.CompletelyBroken), // A laptop internal camera someone found broken
                    new QuirkyCamera(0x0, 0x0, CameraQuirk.CompletelyBroken), // SnapCamera on Windows
