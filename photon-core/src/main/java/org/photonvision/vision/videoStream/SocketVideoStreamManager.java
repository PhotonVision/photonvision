...
public class SocketVideoStreamManager {
    ...
    public void addSubscription(WsContext user, int streamPortID){
        ...
        if(stream != null){
            ...
            logger.error("User attempted to subscribe to non-existent port " + Integer.toString(streamPortID));
        }
    }
    ...
    public void removeSubscription(WsContext user, int streamPortID){
        ...
        if(stream != null){
            ...
            logger.error("User attempted to un-subscribe to non-existent port " + Integer.toString(streamPortID));
        }
    }
