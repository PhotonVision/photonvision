...
import static org.photonvision.vision.pipe.impl.Calibrate3dPoseGuidance.ArrayUtils.argmax;
...
/*-------------------------------------------------------------------------------------------------*/
     ...
     * @throws Exception
     */
    public void draw(Mat img, boolean mirror) throws Exception // force users to specify mirror false instead of defaulting
    {
        // logger.debug("method entered  . . . . . . . . . . . . . . . . . . . . . . . .");
