...
public class Calib3dorFisheye {
    ...
    public static void projectPoints(
        ...
        if (isFisheye(distCoeffs)) {
            ...
            Calib3d.projectPoints(
                    objectPoints, rvec, tvec, cameraMatrix, new MatOfDouble(distCoeffs), imagePoints);
        }
    }
    ...
    public static void old_distortPoints(
    ...
    public static void solvePnP(
        ...
        if (isFisheye(distCoeffs)) {
            ...
            Calib3d.fisheye_undistortPoints(
                    imagePoints, undistortedImagePoints, cameraMatrix, distCoeffs);
            Calib3d.solvePnP(
                    objectPoints,
                    undistortedImagePoints,
                    Mat.eye(new Size(3, 3), CvType.CV_8UC1),
                    new MatOfDouble(Mat.zeros(new Size(1, 5), CvType.CV_64F)),
                    rvec,
                    tvec);
        } else {
