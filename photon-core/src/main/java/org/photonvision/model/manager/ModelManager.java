 ...
 * saving models of a particular type (e.g., RKNN files, CoreML packages).
 */
public interface ModelManager {
    ...
    /**
     * Gets the unique identifier name for this backend format. This name is used internally and
     * potentially in configuration/logging. Example: "RKNN", "COREML_FILE", "COREML_PACKAGE"
     *
     ...
     * handler. Used during model discovery.
     *
    ...
    /**
     * Checks if the given uploaded filenames potentially correspond to this model format. This check
     ...
     * format and that their components match.
     *
    ...
    /**
     * Saves the uploaded model and labels files to the specified directory. For package formats, this
     * includes unzipping the model archive.
     *
