...
public class PoseGeneratorDist {
    ...
    static Pose pose =
            Pose.NONE; // probably shouldn't be static but they are mostly used in a static method and

    // there is only one instantiation
    ...
    private static Mat unproject(MatOfPoint2f p, Mat K, Mat cdist, double Z) {
        ...
        Calib3d.undistortPointsIter(
                p, p, K, cdist, new Mat(), new Mat(), Cfg.undistortPointsIterCriteria);
