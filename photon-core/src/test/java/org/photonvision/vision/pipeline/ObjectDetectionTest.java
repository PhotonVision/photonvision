...
public class ObjectDetectionTest {
    ...
    private static LinkedList<String[]> passNames = new LinkedList<String[]>(java.util.Arrays.asList(
        ...
        new String[] {"example_1.2-640-640-yolov5l.rknn", "example_1.2-640-640-yolov5l-labels.txt"},
        ...
        new String[] {"test_case-640-640-yolov8s.rknn", "test_case-640-640-yolov8s-labels.txt"},
        new String[] {"model_ABC-640-640-yolov5n.rknn", "model_ABC-640-640-yolov5n-labels.txt"},
        ...
        new String[] {"valid_name-640-640-yolov8s.rknn", "valid_name-640-640-yolov8s-labels.txt"}, 
        new String[] {"test.model-640-640-yolov5l.rknn", "test.model-640-640-yolov5l-labels.txt"},
        new String[] {"case1_test-640-640-yolov8m.rknn", "case1_test-640-640-yolov8m-labels.txt"}, 
        new String[] {"A123-640-640-yolov5x.rknn", "A123-640-640-yolov5x-labels.txt"}, 
        new String[] {"z_y_test.model-640-640-yolov8n.rknn", "z_y_test.model-640-640-yolov8n-labels.txt"}

    ));

    private static LinkedList<String[]> failNames = new LinkedList<String[]>(java.util.Arrays.asList(
    ...
    @Test
    public static void testNameVerification(LinkedList<String[]> passNames, LinkedList<String[]> failNames) {
