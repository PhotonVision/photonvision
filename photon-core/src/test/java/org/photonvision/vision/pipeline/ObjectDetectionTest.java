...
public class ObjectDetectionTest {
    private static LinkedList<String[]> passNames = new LinkedList<String[]>(
    ...
    private static LinkedList<String[]> parsedPassNames = new LinkedList<String[]>(
            java.util.Arrays.asList(
    ...
    private static LinkedList<String[]> failNames = new LinkedList<String[]>(
            java.util.Arrays.asList(
