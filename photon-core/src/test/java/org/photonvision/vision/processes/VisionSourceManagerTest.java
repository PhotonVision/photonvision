...
public class VisionSourceManagerTest {
    ...
    //         CameraInfo info1 =
    //                 CameraInfo.fromUsbCameraInfo(0, "dev/video0", "testVideo", new String[]
    // {"/usb/path/0"}, 1, 2);
    ...
    //         CameraInfo info2 =
    //                 CameraInfo.fromUsbCameraInfo(0, "dev/video1", "secondTestVideo", new String[]
    // {"/usb/path/1"}, 2, 3);
    ...
    //         CameraInfo info3 =
    //                 CameraInfo.fromUsbCameraInfo(0, "dev/video2", "thirdTestVideo", new String[]
    // {"by-id/123"}, 3, 4);

    //         CameraInfo info4 =
    //                 CameraInfo.fromUsbCameraInfo(0, "dev/video3", "fourthTestVideo", new String[]
    // {"by-id/321"}, 5, 6);
    ...
    //                 cams.stream()
    //                         .filter(
    //                                 cam -> cam.otherPaths.length > 0 &&
    // cam.otherPaths[0].equals(config4.otherPaths[0]))
    //                         .findFirst()
    //                         .orElse(null);
    ...
    //                         .filter(
    //                                 cam -> cam.otherPaths.length > 0 &&
    // cam.otherPaths[0].equals(config3.otherPaths[0]))
    //                         .findFirst()
    //                         .orElse(null);
    //         cam4 =
    //                 cams.stream()
    ...
    //         assertTrue(!inst.knownCameras.contains(info7)); // This camera should not be
    // recognized/used.
    ...
    //         assertTrue(!inst.knownCameras.contains(info8)); // This camera should not be
    // recognized/used.
    ...
    //         assertTrue(!inst.knownCameras.contains(info9)); // This camera should not be
    // recognized/used.
    ...
    //         var CAM2_NEW_PATH =
    //                 new String[]
    // {"/dev/v4l/by-path/platform-fc880080.usb-usb-0:1:1.3-video-index0"};
    ...
    //             CameraInfo info1 =
    //             CameraInfo.fromUsbCameraInfo(
    //                             0, "/dev/video11", "Arducam OV2311 USB Camera", CAM1_OLD_PATHS,
    // 3141, 25446);
    //             CameraInfo info2 =
    //                     CameraInfo.fromUsbCameraInfo(0, "/dev/video12", "Arducam OV2311 USB
    // Camera", CAM2_NEW_PATH, 3141, 25446);
    ...
    //             assertEquals(
    //                     1, ret1.stream().filter(it ->
    // it.cameraConfiguration.path.equals(info1.path)).count());
    //             assertEquals(
    //                     1, ret1.stream().filter(it ->
    // it.cameraConfiguration.path.equals(info2.path)).count());
    //         }
    //     }
    ...
    //             CameraInfo info2 =
    //                     CameraInfo.fromUsbCameraInfo(
    //                             0, "/dev/video12", "Arducam OV2311 USB Camera", CAM2_NEW_PATH,
    // 3141, 25446);
    ...
    //             CameraInfo info2 =
    //                     CameraInfo.fromUsbCameraInfo(
    //                             0, "/dev/video12", "Arducam OV2311 USB Camera", CAM2_OLD_PATH,
    // 3141, 25446);
    ...
    //         var camera1_saved_config =
    //                 new CameraConfiguration(
    //                         "OV9281", "OV9281", "test-1", "/base/soc/i2c0mux/i2c@0/ov9281@60", new
    // String[0]);
    ...
    //         var camera2_saved_config =
    //                 new CameraConfiguration(
    //                         "OV9281", "OV9281 (1)", "test-2", "/base/soc/i2c0mux/i2c@1/ov9281@60",
    // new String[0]);
    ...
    //             assertEquals(
    //                     1, ret1.stream().filter(it ->
    // testPath.equals(it.cameraConfiguration.path)).count());
    //         }
    //     }
    ...
    //         CameraInfo info1 =
    //                 CameraInfo.fromUsbCameraInfo(0, "/dev/video0", "Arducam OV2311 USB Camera", new
    // String[] {}, 3141, 25446);
    ...
    //                     ret1.stream()
    //                             .filter(it ->
    // testPath.equals(it.cameraConfiguration.getUSBPath().get()))
    //                             .count());
    //         }
    ...
    //             assertEquals(
    //                     1,
    //                     ret1.stream().filter(it ->
    // thisName.equals(it.cameraConfiguration.uniqueName)).count());
    //         }
    ...
    //         // duplicate cameras this simulates unplugging one and plugging the other in where v4l
    // assigns
