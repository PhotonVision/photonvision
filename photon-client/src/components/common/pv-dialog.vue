  ...
  <dialog-root v-model:open="model">
    <dialog-portal>
      ...
      <dialog-content
        :style="contentStyle"
        :class="[
          'fixed top-1/2 left-1/2 z-[2401] max-h-[calc(100vh-2rem)]  -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-[12px] border border-white/10 bg-pv-surface text-white shadow-2xl shadow-black/50 outline-none',
          contentClass
        ]"
