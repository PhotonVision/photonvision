...
<template>
  <v-card class="mb-3" color="primary" dark>
    <v-card-title class="pa-5 pb-0">Camera Settings</v-card-title>
    ...
    <v-dialog v-model="showDeleteCamera" width="800">
      <v-card class="pa-5" color="primary" flat>
        <v-card-title class="pa-0">
          Delete {{ useCameraSettingsStore().currentCameraSettings.nickname }}?
        </v-card-title>
