  ...
  <div>
    ...
    <v-dialog v-model="exportInProgress" width="500px" :persistent="true">
      <v-card color="primary" dark>
        <v-card-title class="pb-8"> Camera Calibration Export </v-card-title>
        <div class="ml-3">
          <v-col style="text-align: center">
            <v-progress-circular indeterminate :size="70" :width="8" color="accent" />
            <v-card-text
              >Exporting camera calibration. On a robot via WiFi, this may take up to a minute; connecting directly via
              Ethernet will make this go up to 200x faster :)
            </v-card-text>
          </v-col>
        </div>
      </v-card>
