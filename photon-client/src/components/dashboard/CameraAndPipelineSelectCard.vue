...
<template>
  <v-card color="primary">
    ...
    <v-dialog v-model="showPipelineCreationDialog" persistent width="500">
      <v-card color="primary">
        <v-card-title class="pa-5 pb-0">Create New Pipeline</v-card-title>
    ...
    <v-dialog v-model="showPipelineDeletionConfirmationDialog" width="500">
      <v-card color="primary">
        <v-card-title class="pa-5 pb-0">Pipeline Deletion Confirmation</v-card-title>
    ...
    <v-dialog v-model="showPipelineTypeChangeDialog" persistent width="600">
      <v-card color="primary" dark>
        <v-card-title class="pa-5 pb-0">Change Pipeline Type</v-card-title>
        <v-card-text class="pa-5">
