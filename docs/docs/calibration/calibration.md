...
Calibration images can also be extracted from the downloaded JSON file using [this Python script](https://github.com/PhotonVision/photonvision/blob/master/devTools/calibrationUtils.py). This script will unpack calibration images, and also generate a VNL file for use [with mrcal](https://mrcal.secretsauce.net/).
...
![A diagram showing residual directions](images/residual-directions.svg)
...
![A diagram showing camera uncertainty](images/camera-uncertainty.svg)
