...
For the 2025 season, we do not have plans to release an object detection model ourselves, but if someone in the community is interested in creating one, we would be happy to integrate it.
