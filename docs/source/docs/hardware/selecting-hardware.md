...
:::{note}
It is highly reccomended that you read the {ref}`quick start guide<docs/quick-start/common-setups:Common Hardware Setups>`, and use the hardware reccomended there, that 
