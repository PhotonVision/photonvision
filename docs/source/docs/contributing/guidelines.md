...
Any and all prose should be human written, with no generative AI usage. This includes issues and PR descriptions on GitHub, the intent is that any communication that is read by a human should be written by a human. Authors who submit AI-generated writing will be asked to rewrite, repeated violations will result in an auto-close.
