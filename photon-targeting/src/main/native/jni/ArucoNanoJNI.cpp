...
#include <org_photonvision_jni_ArucoNanoDetector.h>
...
/*
 * Class:     org_photonvision_jni_ArucoNanoDetector
 * Method:    detect
 * Signature: (J)[D
 */
JNIEXPORT jdoubleArray JNICALL
Java_org_photonvision_jni_ArucoNanoDetector_detect(JNIEnv* env, jclass,
                                                   jlong matPtr) {
