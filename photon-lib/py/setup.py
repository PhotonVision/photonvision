...
setup(
    ...
    install_requires=[
        "numpy~=2.3",
        "wpilib>=2027.0.0a5.post1,<2028",
        "robotpy-wpimath>=2027.0.0a5.post1,<2028",
        "robotpy-apriltag>=2027.0.0a5.post1,<2028",
        "robotpy-cscore>=2027.0.0a5.post1,<2028",
        "pyntcore>=2027.0.0a5.post1,<2028",
